package id.ajr.japos.member.process;
...
import id.ajr.japos.db.postgresql.repository.MasterMemberRepository;
import id.ajr.japos.member.model.ResponseGetMember;
